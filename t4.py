...
def generate_recommendations(df, sig_results, contrib_sorted, desc_df):
    ...
    print("  基于Logistic GAM模型分析，以下变量对糖尿病风险贡献最大：")
    print("  1. %s\n  2. %s\n  3. %s" % (top3_names[0], top3_names[1], top3_names[2]))
    print()
    print("  筛查优先级排序：")
    print("  - 极高优先：年龄>55岁 且 TG>2.3 mmol/L 的个体（高风险亚群聚集）")
    print("  - 高度优先：年龄>55岁 或 TG>2.3 mmol/L 的个体")
    print("  - 中度优先：具备上述任一风险因素且有其他代谢异常（如LDL-C偏高、WBC偏高）")
    print("  - 建议对以上人群优先安排口服葡萄糖耐量试验（OGTT）确认诊断")
    print()
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("二、高风险人群概况")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("  高风险人群（Top 20%%预测风险）特征概要：")
    print("  - 人数: %d / %d (%.1f%%)" % (n_high, n_total, high_ratio))
    print("  - 平均年龄: %.1f岁" % avg_age_high)
    print("  - 男性比例: %.1f%%" % male_ratio_high)
    print("  - 平均TG: %.2f mmol/L" % avg_tg_high)
    print("  - 年龄>55岁占比: %.1f%%" % old_high)
    print("  - 年龄>55岁且TG>2.3: 重点关注亚群")
    print()
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("三、干预靶点建议")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("  血脂管理（核心靶点）：")
    print("  - TG偏高是该高风险人群最突出的可干预因素")
    print("  - 建议加强血脂管理健康宣教，包括低糖低脂饮食、规律运动")
    print("  - 必要时在医生指导下使用降脂药物")
    print()
    print("  血糖监测：")
    print("  - 高风险人群建议每年至少检测1次空腹血糖和糖化血红蛋白")
    print("  - 年龄>55岁合并TG>2.3者建议每半年检测1次")
    print()
    print("  生活方式干预：")
    print("  - 建议高风险人群参加系统的糖尿病预防计划")
    print("  - 体重管理（如BMI>24）、增加体力活动、减少久坐")
    print()
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("四、资源分配建议")
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    male_bias = "男性" if (df[df["高风险"]==1]["性别"] >= 0.5).mean() > 0.5 else "女性"
    print("  性别分布：%s在高风险人群中占比偏高，建议在%s群体中增加筛查资源投入。" % (male_bias, male_bias))
    print("  年龄分布：年龄是最重要的非修饰风险因素，建议对55岁以上人群建立常规筛查机制。")
    print("  资源效率：将OGTT等确诊检查资源集中在高危亚群（年龄>55且TG>2.3），")
    print("           可在有限资源下最大化检出效率。")
    print(SEP)
...
def plot_interaction_heatmap(df, risk_col="风险概率"):
    ...
    risk_grid = np.zeros((len(tg_bins)-1, len(age_bins)-1))
